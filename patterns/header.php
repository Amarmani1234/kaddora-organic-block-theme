 ...
 */
?>
<!-- wp:group {"className":"kaddora-header","style":{"spacing":{"blockGap":"0.5rem"}},"layout":{"type":"default"}} -->
...
<div class="wp-block-group site-identity"><!-- wp:site-logo {"width":185} /--></div>
<!-- /wp:group -->

<!-- wp:group {"className":"search-actions","style":{"dimensions":{"minHeight":""},"spacing":{"padding":{"top":"0","bottom":"0"},"margin":{"top":"0","bottom":"0"},"blockGap":"var:preset|spacing|10"}},"fontSize":"medium","layout":{"type":"flex","flexWrap":"wrap","justifyContent":"center"}} -->
<div class="wp-block-group search-actions has-medium-font-size" style="margin-top:0;margin-bottom:0;padding-top:0;padding-bottom:0"><!-- wp:search {"label":"Search","showLabel":false,"placeholder":"Search for products","width":100,"widthUnit":"%","buttonText":"Search","buttonPosition":"button-inside","buttonUseIcon":true,"style":{"border":{"radius":"25px"},"typography":{"fontSize":"0.9rem"},"layout":{"selfStretch":"fit","flexSize":null}}} /-->

<!-- wp:buttons {"style":{"typography":{"fontSize":"0.5rem"}},"layout":{"type":"flex","orientation":"horizontal","justifyContent":"left"}} -->
<div class="wp-block-buttons has-custom-font-size" style="font-size:0.5rem"><!-- wp:button {"textAlign":"center","className":"is-style-outline","style":{"typography":{"fontSize":"0.7rem"}}} -->
<div class="wp-block-button is-style-outline"><a class="wp-block-button__link has-text-align-center has-custom-font-size wp-element-button" style="font-size:0.7rem">Login</a></div>
<!-- /wp:button -->

<!-- wp:button {"className":"is-style-outline","style":{"typography":{"fontSize":"0.7rem"}}} -->
<div class="wp-block-button is-style-outline"><a class="wp-block-button__link has-custom-font-size wp-element-button" style="font-size:0.7rem">Sign UP</a></div>
<!-- /wp:button --></div>
<!-- /wp:buttons --></div>
<!-- /wp:group --></div>
<!-- /wp:group -->
...
<div class="wp-block-group" style="padding-top:0rem;padding-bottom:0rem;font-size:1.3rem"><!-- wp:woocommerce/customer-account {"displayStyle":"icon_only","iconClass":"wc-block-customer-account__account-icon","fontSize":"medium"} /-->

<!-- wp:woocommerce/mini-cart {"miniCartIcon":"bag-alt","hasHiddenPrice":false,"productCountVisibility":"always","fontSize":"medium"} /--></div>
<!-- /wp:group --></div>
<!-- /wp:group --></div>
<!-- /wp:group -->